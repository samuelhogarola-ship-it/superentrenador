...
export const publicTrainerProfiles: PublicTrainerProfile[] = [
  ...
  {
    id: "trainer-elena-pilates-fuengirola",
    slug: "elena-pilates-fuengirola",
    displayName: "Elena",
    citySlug: "fuengirola",
    city: "Fuengirola",
    region: "Málaga",
  ...
  {
    id: "trainer-david-padel-fuengirola",
    slug: "david-padel-fuengirola",
    displayName: "David",
    citySlug: "fuengirola",
    city: "Fuengirola",
    region: "Málaga",
